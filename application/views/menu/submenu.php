                ...
                <tbody>
                    ...
                    <?php foreach ($SubMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <button href="" class="btn btn-success" data-toggle="modal" data-target="#exampleModalsubedit<?= $sm['id']; ?>">Edit</button>
                                <button onclick="hapusSubmenu('<?= base_url('menu/hapus/') . $sm['id'] ?>')" class="btn btn-danger">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<!-- Modal -->
<div class="modal fade" id="logoutModal" tabindex="-1" aria-labelledby="newSubMenuModalLabel" aria-hidden="true">
